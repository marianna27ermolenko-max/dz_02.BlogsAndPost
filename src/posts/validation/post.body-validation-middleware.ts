...
export const shortDescriptionPostValidation = body("shortDescription")
  ...
  .withMessage("ShortDescription cannot be longer than 100 characters")
  .trim()
  .notEmpty()
...
export const blogIdPostValidation = body("blogId")
  ...
  .isLength({ min: 1, max: 100 })
  .withMessage("BlogId cannot be longer than 100 characters")
  .trim()
  .notEmpty()
...
export const postInputWithoutBlogIdValidationMiddleware = [
  titlePostValidation,
  shortDescriptionPostValidation,
  contentPostValidation,
];

export const commentByPostIdInputValidationMiddleware = [
